...
Hero geometry, wordmark, typography, CTAs, metadata and cloud positioning are preserved. Cloud opacity is 0.65 (65%). Existing navigation and CTAs now link to the relevant homepage sections. The hero wrapper is a semantic section inside the page's single main landmark.
